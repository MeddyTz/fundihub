    ...
    return GridView.builder(
      ...
      itemBuilder: (context, i) {
        ...
        return GestureDetector(
          onTap: () {
            // Pass this fundi's exact reels list so ReelsScreen shows
            // ONLY their reels — not the global approved feed.
            context.push('/reels', extra: {
              'fundiReelsList': reels,  // List<ReelModel> — casts correctly
              'initialIndex':   i,
            });
          },
          child: ClipRRect(
